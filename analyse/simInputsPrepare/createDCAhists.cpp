...
//    float const ptEdge[nPtBins + 1] = {0.15, 0.3, 0.4, 0.6, 0.8, 1., 1.2, 1.5, 2., 4., 12.};

    const int nPtBins = 11;
    float const ptEdge[nPtBins + 1] = {0.15, 0.3, 0.4, 0.5, 0.6, 0.8, 1., 1.25, 1.5, 2., 5., 12.};
...
//                            cout << "Number of particles recorded: " << hist2D->GetEntries()
//                                << "particle "<<iParticle
